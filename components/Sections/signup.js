...
import TextMorph from '../UX-Components/textmorph';
        ...
        <>
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    <div class="mx-auto max-w-screen-md sm:text-center">
                        <h2 class="mb-4 text-2xl tracking-tight text-gray-900 sm:text-4xl dark:text-white">Sign up for our newsletter</h2>
